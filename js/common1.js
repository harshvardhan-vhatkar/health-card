window.addEventListener("load", function () {
    var signup_form = document.getElementById("hospital-signup-form");
    signup_form.addEventListener("submit", function (event) {
        ...
        // Set up request
        XHR.open("POST", "api/hospital_signup_submit.php");
    ...
    var login_form = document.getElementById("hospital-login-form");
    login_form.addEventListener("submit", function (event) {
        ...
        // Set up request
        XHR.open("POST", "api/hospital_login_submit.php");
