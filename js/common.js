window.addEventListener("load", function () {
    var signup_form = document.getElementById("patient-signup-form");
    signup_form.addEventListener("submit", function (event) {
        ...
        // Set up request
        XHR.open("POST", "api/patient_signup_submit.php");
    ...
    var login_form = document.getElementById("patient-login-form");
    login_form.addEventListener("submit", function (event) {
        ...
        // Set up request
        XHR.open("POST", "api/patient_login_submit.php");
